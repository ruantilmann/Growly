...
const IDENTIFY_USER_PROMPT = "Identifique a planta da imagem seguindo rigorosamente o processo botanico e o formato exigido no campo summary.";
...
function resolveConfidence(value) {
  ...
  if (typeof value === "string") {
    ...
    if (normalized === "medio" || normalized === "m\xE9dio" || normalized === "medium") {
      return 0.65;
    }
