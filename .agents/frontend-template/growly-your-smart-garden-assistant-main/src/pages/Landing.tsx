    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container flex flex-col items-center justify-center text-center py-20 max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 w-full text-left">
          {[
            { title: 'Identificação', desc: 'Reconhecimento de espécies por análise fotométrica.' },
            { title: 'Diagnóstico', desc: 'Detecção de doenças e deficiências nutricionais.' },
            { title: 'Plano de cuidados', desc: 'Regas, podas e fertilizações agendadas automaticamente.' },
          ].map((f) => (
      ...
      <footer className="container py-6 text-center">
        <p className="font-body text-xs text-muted-foreground">© 2026 Growly. Seu assistente inteligente de cultivo.</p>
      </footer>
    </div>
  );
};
